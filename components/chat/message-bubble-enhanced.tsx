                                        ...
                                        <div className="mb-2">
                                            <img
                                                ...
                                                onError={(e) => {
                                                    ...
                                                    e.currentTarget.parentElement?.insertAdjacentHTML('beforeend', '<div class="p-4 bg-gray-100 dark:bg-gray-800 rounded-lg text-sm text-gray-500 italic">Image not available</div>');
                                                }}
                                            />
                                        </div>
